...
# Define the contrastive loss function for the Siamese network
...
siamese_network = tf.keras.models.load_model('siamese_network_vgg_flowers.h5', custom_objects={'contrastive_loss': contrastive_loss})

# Function to preprocess a single image
def preprocess_image(img):
    # If img is a file path, load it as an image
...
def predict_similarity_for_pairs(image_pairs_test):
    ...
    save_path = 'cosine_sim/cosine_sim_siameseNet_vgg_flower.npy'
