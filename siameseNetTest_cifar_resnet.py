...
# Load the saved Siamese network model
siamese_network = tf.keras.models.load_model('siamese_network_resnet_cifar10.h5', custom_objects={'contrastive_loss': contrastive_loss})
