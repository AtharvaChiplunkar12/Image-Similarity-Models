...
# Load CIFAR-10 dataset (only test data)
...
def save_pairs(pairs, filename="cifar10_image_pairs_test.pkl"):
...
all_image_pairs = create_image_pairs(x_test, y_test, num_images_per_class)
